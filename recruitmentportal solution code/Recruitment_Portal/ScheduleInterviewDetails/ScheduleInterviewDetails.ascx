...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ScheduleInterviewDetails.ascx.cs" Inherits="Recruitment_Portal.ScheduleInterviewDetails.ScheduleInterviewDetails" %>

<asp:Button ID="BtnEmployee" runat="server" Text="Schedule Interview" OnClick="BtnEmployee_Click" class="btn btn-default blu_btn" />
...
<br />
 ...
 <asp:GridView ID="oGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" OnRowCancelingEdit="oGridView_RowCancelingEdit" AllowPaging="true" OnPageIndexChanging="oGridView_PageIndexChanging"
        OnRowEditing="oGridView_RowEditing" OnRowUpdating="oGridView_RowUpdating" OnRowDeleting="oGridView_RowDeleting" AllowSorting="True" CaptionAlign="Top" OnRowDataBound="oGridView_RowDataBound" CssClass="table lats_submsn">
        ...
        <Columns>
           <%-- <asp:TemplateField HeaderText="ID" HeaderStyle-HorizontalAlign="Left">
                ...
                <ItemTemplate>
                   ...
                   <%--   <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Bind("ID", "/sitePages/Details.aspx?ID={0}") %>'
                    Text='<%# Bind("ID") %>' />--%>
...
<%--                </ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Vacancy Name" HeaderStyle-HorizontalAlign="Left">
                <EditItemTemplate>
                    <%--<asp:DropDownList ID="VacancynName" runat="server" Text='<%# Bind("Vacancy") %>'></asp:DropDownList>--%>
                    <asp:Label ID="VacancyName" runat="server" Text='<%# Bind("Vacancy") %>'></asp:Label>
                   </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="lblVavancyName" runat="server" Text='<%# Bind("Vacancy") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Candidate Name" HeaderStyle-HorizontalAlign="Left">
                <EditItemTemplate>
                    <asp:DropDownList ID="txtnName" runat="server"></asp:DropDownList>
                </EditItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Interview DateTime" HeaderStyle-HorizontalAlign="Left">
                <EditItemTemplate>
                    <%-- <SharePoint:DateTimeControl ID="Date1" runat="server" />  --%>
                    <asp:Label ID="lblnDate" runat="server" Text='<%# Bind("InterviewDate") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="lblDate" runat="server" Text='<%# Bind("InterviewDate") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Interviewer" HeaderStyle-HorizontalAlign="Left">
                <EditItemTemplate>
                    ...
                    <asp:Label ID="lblnInterviewer" runat="server" Text='<%# Bind("Interviewers") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="lblInterviewer" runat="server" Text='<%# Bind("Interviewers") %>'></asp:Label>
                </ItemTemplate>
                <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Remarks" HeaderStyle-HorizontalAlign="Left">
                <EditItemTemplate>
                    <asp:Label ID="lblnRemarks" runat="server" Text='<%# Bind("Remarks") %>'></asp:Label>
                </EditItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Status" HeaderStyle-HorizontalAlign="Left">
                <EditItemTemplate>
                    <asp:DropDownList ID="drpnStatus" runat="server" SelectedValue='<%# Bind("Status") %>'>
